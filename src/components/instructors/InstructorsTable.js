...
const InstructorsTable = ({ modalOpen, enableEdit, openModal, closeModal, openReviewForm }) => {
                            ...
                            <td>
                                <div className={styles.instructorName}>
                                    <div className={styles.imgContainer}>
                                        <Image objectFit='cover' objectPosition='-25px' layout='fill' alt="Picture of the author" src='https://app-ambly.s3.amazonaws.com/static/uploads/2ef1d694be90a321916d-3JA4YFJT45GIZEPRSHZBC7JUEI.jpg' />
                                    </div>
                            ...
                            <td>
                                <div className={styles.actionIcons}>
                                    <div className={styles.icon}>
                                        <div
                                            onClick={() => { modalOpen ? closeModal() : openModal(), enableEdit() }}
                                        >
                                        ...
                                        <div
                                            onClick={() => { modalOpen ? closeModal() : openModal(), openReviewForm()}}
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
